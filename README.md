...
* [LibreSSL](https://www.libressl.org) - stable releases in the following series
  ...
  * 3.6 series (3.6.1 - 3.6.3)
  * 3.7 series (3.7.2 - 3.7.3)
  * 3.8 series (3.8.2 - 3.8.4)
  * 3.9 series (3.9.1 - 3.9.2)
  * 4.0 series (4.0.0 - 4.0.1)
  * 4.1 series (4.1.0 - 4.1.2)
  * 4.2 series (4.2.0 - 4.2.1)
* [OpenSSL](https://www.openssl-library.org) - stable releases in the following branches
  ...
  * 3.0 branch (3.0.0 - 3.0.5, 3.0.7 - 3.0.19)
  * 3.1 branch (3.1.0 - 3.1.8)
  * 3.2 branch (3.2.0 - 3.2.6)
  * 3.3 branch (3.3.0 - 3.3.6)
  * 3.4 branch (3.4.0 - 3.4.4)
  * 3.5 branch (3.5.0 - 3.5.6)
  * 3.6 branch (3.6.0 - 3.6.2)
  * 4.0 branch (4.0.0)
